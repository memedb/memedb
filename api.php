...
function memePreview() {
  ?>
  <div class="meme-preview-box-hover" style="display: none;">
    ...
    <div class="m-new-container-hover">
      ...
      <div class="m-desc-hover">
        <div class="m-post-info">
          ...
          <h1 class="m-date">24 May 2018</h1>
        </div>
...
class post {
  ...
  public function printImage($class, $resizeHolder, $width) {
    ...
    ?>
    <img class="<?=$class?>" src="/images/<?=($this->original ? $this->original : $this->id) . "." . $this->type?>" style="<?=$resizeHolder ? "height: ".$height."px;" : ""?>">
    <?php
  }
