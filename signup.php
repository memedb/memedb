  ...
  <div class="signup-block">
    ...
    <form method="post" action="<?php echo $_SERVER['PHP_SELF'];?>">
      <div style="margin-bottom:20px;">
        <div class="input">
          <input id="name" name="name" type="text" placeholder="Username" pattern="[a-zA-Z0-9_]{1,32}" maxlength="32" title="No more than 32 characters and no special characters." style="all: unset; width: 100%;position: relative; border-bottom: 2px solid #ff8e8e;" required />
        </div>
      ...
      <div style="margin-bottom:20px;">
        <div class="input">
          <input id="email" name="email" type="email" placeholder="Email" style="all: unset; width: 100%;position: relative; border-bottom: 2px solid #ff8e8e;" required />
        </div>
      ...
      <div style="margin-bottom:20px;">
        <div class="input">
          <input id="pwd1" type="password" placeholder="Password" pattern="{8,}" title="At least 8 characters." style="all: unset; width: 100%;position: relative; border-bottom: 2px solid #ff8e8e;" required />
        </div>
      ...
      <div style="margin-bottom:20px;">
        <div class="input">
          <input id="pwd2" type="password" placeholder="Repeat Password" pattern="{8,}" title="At least 8 characters." style="all: unset; width: 100%;position: relative; border-bottom: 2px solid #ff8e8e;" required />
        </div>
